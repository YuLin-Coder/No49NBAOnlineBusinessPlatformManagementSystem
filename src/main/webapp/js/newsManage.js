...
$(document).on("click",".templatemo-edit-btn",function () {
    ...
    var upGoodsDetailCate = $(this).parents("tr").find("td:eq(2)").text();
...
function build_goods_table(path,result) {
    ...
    $.each(goods, function (index,item) {
        ...
        var detailA = $("<a></a>").addClass("templatemo-link").attr("href","../../newsdetail?goodsid="+item.goodsid).append("详情");
        ...
        $("<tr></tr>").append(goodsid).append(goodsname).append(detailcate).append(desTd).append(detailTd).append(editTd).append(deleteTd).appendTo("#goodsinfo tbody");
    })
}
