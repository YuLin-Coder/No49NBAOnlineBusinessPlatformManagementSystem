...
<head>
    ...
    <script type="text/javascript">
        function btnSubmit() {
            var txtName = $('#inputWithSuccess').val();
            if(!txtName){
    ...
    <div class="templatemo-content col-1 light-gray-bg">
        ...
        <div class="templatemo-content-container">
            <div class="templatemo-content-widget white-bg">
                ...
                <p>商品的一些基本信息</p>
                <form action="${pageContext.request.contextPath}/admin/goods/addGoodsSuccess" class="templatemo-login-form" method="post" enctype="multipart/form-data" onsubmit="return btnSubmit()">
