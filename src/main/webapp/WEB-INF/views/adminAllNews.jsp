            ...
            <div class="modal-body">
                <form class="form-horizontal" id="update-form" name="update-form" method="post">
                    ...
                    <div class="form-group">
                        ...
                        <div class="form-group">
                            <label for="detailcate" class="col-sm-2 control-label">备注</label>
                            <div class="col-sm-9">
                ...
                <div class="panel panel-default table-responsive">
                    <table id="goodsinfo" class="table table-striped table-bordered templatemo-user-table">
                        ...
                        <tr>
                            ...
                            <td><a href="" class="white-text templatemo-sort-by">资讯名<span class="caret"></span></a></td>
                            <td><a href="" class="white-text templatemo-sort-by">备注<span class="caret"></span></a></td>
                            <td>详情</td>
                            <td>编辑</td>
                            <td>删除</td>
