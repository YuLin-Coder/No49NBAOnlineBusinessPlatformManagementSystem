    ...
    <div class="row">
        <nav class="templatemo-top-nav col-lg-12 col-md-12">
            <ul class="text-uppercase">
                <li><a href="${pageContext.request.contextPath}/admin/news/show">所有资讯</a></li>
                <li><a href="${pageContext.request.contextPath}/admin/news/add">添加资讯</a></li>
        ...
        <div class="templatemo-content-container">
            <div class="templatemo-content-widget white-bg">
                <h2 class="margin-bottom-10">添加资讯</h2>
                <p></p>
                <form action="${pageContext.request.contextPath}/admin/news/addNewsSuccess" class="templatemo-login-form" method="post" enctype="multipart/form-data">
                    <div class="row form-group">
                        <div class="col-lg-12 form-group">
                            <label class="control-label" for="inputWithSuccess">资讯名称</label>
                            <input type="text" class="form-control" id="inputWithSuccess" name="goodsname">
                        </div>
                    </div>
                    <input type="hidden" class="form-control" id="inputWithWarning" name="price" value="0">
                    <input type="hidden" class="form-control" id="inputWithError" name="num" value="1">
                    <!-- <div class="row form-group">
                    ...
                    <div class="row form-group">
                        <div class="col-lg-12 form-group">
                            <label class="control-label" for="inputNote">资讯内容</label>
                            <textarea class="form-control" id="inputNote" rows="10" name="description"></textarea>
                        </div>
                    </div>
                    <div class="row form-group">
                        ...
                        <div class="col-lg-6 col-md-6 form-group">
                            <label class="control-label" for="inputWithSuccess2">备注</label>
...
<%--                    <div class="row form-group">
                        <div class="col-lg-12">
                            <label class="control-label templatemo-block">视频（支持MP4格式）</label>
                            <!-- <input type="file" name="fileToUpload" id="fileToUpload" class="margin-bottom-10"> -->
                            <input type="file" name="fileToUpload" id="fileToUpload2" class="filestyle" data-buttonName="btn-primary" data-buttonBefore="true" data-icon="false" multiple="multiple">
                            <!-- <p>Maximum upload size is 5 MB.</p>  -->
                        </div>
                    </div>--%>
