	...
	<div id="main" class="container">
		...
		<div class="content">
			...
			<div class="btn-group" role="group" aria-label="...">
				<a href="${pageContext.request.contextPath}/news?cate=" class="btn btn-default" role="button">全部</a>
				<c:forEach items="${categoryList}" var="category">
					<a href="${pageContext.request.contextPath}/news?cate=${category.catename}" class="btn btn-default" role="button">${category.catename}</a>
				</c:forEach>
