...
import org.healthbeauty.pojo.Favorite;
import org.healthbeauty.pojo.FavoriteKey;
...
import org.healthbeauty.pojo.GoodsExample.Criteria;
	...
	public String addGoods(Goods goods, @RequestParam MultipartFile[] fileToUpload, HttpServletRequest request,
		...
		for (MultipartFile multipartFile : fileToUpload) {
			if (multipartFile != null) {
				...
				String imageName = UUID.randomUUID().toString().replace("-", "").toLowerCase() + "." + extensionName;
